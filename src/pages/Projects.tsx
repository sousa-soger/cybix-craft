    ...
    >
      ...
      {filtered.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
          {filtered.map((p) => {
            const repoCount = repositories.filter((r) => r.projectId === p.id).length;
            const teamCount = teams.filter((t) => t.projectIds.includes(p.id)).length;
      ...
      {/* Detail panel */}
      {selected && (
        <section className="mt-6 section-card p-0 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/60">
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[11px] text-muted-foreground">{selectedRepos.length}</span>
              </div>
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[11px] text-muted-foreground">{selectedTeams.length}</span>
              </div>
